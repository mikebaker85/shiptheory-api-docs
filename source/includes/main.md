...
background_colour | no       | Background colour of the tag. Must be a valid hex colour, the pattern for which is: `/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/`
text_colour       | no       | Text colour of the tag. Must be a valid hex colour, the pattern for which is: `/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/`
